    ...
    */
    ...
    // Part 5 - case 2 //To test the zig and zag
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case2!"
                      << ". \033[0m\n";
        }
    }
    ...
    // Part 5 - case 3 //To test the zig and zag
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case3!"
                      << ". \033[0m\n";
        }
    }
    ...
    // Part 5 - case 4
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case4!"
                      << ". \033[0m\n";
        }
    }
    ...
    // Part 5 - case 5
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case5!"
                      << ". \033[0m\n";
        }
        delete bst;
    }
    // Part 5 - case 6
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case6!"
                      << ". \033[0m\n";
        }
        delete bst;
        delete node;
    ...
    // Part 5 - case 7
    {
        ...
        try {
            ...
            std::cout << "\033[41;11m Error in part 5, case7!"
                      << ". \033[0m\n";
        }
        delete_tree(bst->root);
        delete bst;
