...
set_property PACKAGE_PIN W4 [get_ports key_en]
set_property IOSTANDARD LVCMOS33 [get_ports key_en]

set_property IOSTANDARD LVCMOS33 [get_ports laba]
set_property PACKAGE_PIN A19 [get_ports laba]

set_property DRIVE 12 [get_ports laba]
